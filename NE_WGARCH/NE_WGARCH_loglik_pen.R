...
NE_WGARCH_loglik_pen = function(params,r,r0){
  ...
  # introduce sigma0 penalisation
  L_sig0_pen = (sigma0 -0.5)^2/(2*1e-4)
  return(L_NE - L_sig - L_sig0_pen)
  
}


NE_WGARCH_MLE_pen = function(data, init_params = c(1,1,1,1,1,1,
  ...
  Results = optim(par = init_params,
                  fn = NE_WGARCH_loglik_pen,#gr = NE_WGARCH_partial_loglik,
